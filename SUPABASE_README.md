...
Este documento describe la integración de Supabase en el proyecto SmartShip para autenticación y gestión de base de datos.
...
CREATE TABLE pedidos (
  ...
  archivo_nombre text,
  tipo_envio text, -- 'domicilio' o 'sucursal'
  fecha_procesamiento timestamp with time zone DEFAULT now(),
  datos jsonb, -- Almacenar todos los datos del pedido
  created_at timestamp with time zone DEFAULT now()
);
```
