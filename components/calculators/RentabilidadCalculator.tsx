...
const RentabilidadCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 transition-colors duration-300">
      <div className="w-full max-w-7xl mx-auto bg-white dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 space-y-6 border-2 border-gray-200 dark:border-gray-700/50">
        {/* Banner de invitado */}
        {isGuest && (
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border-2 border-yellow-300 dark:border-yellow-500/50">
          <label className="block text-sm font-medium text-yellow-800 dark:text-yellow-300 mb-2">
            💵 Valor Dólar al Día (ARS)
          </label>
          <div className="flex items-center gap-3">
            <span className="text-gray-600 dark:text-gray-400 text-sm">1 USD =</span>
            <input
              type="text"
              ...
              className="flex-1 p-3 border-2 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:outline-none font-bold text-lg"
              placeholder="1440"
            />
            <span className="text-gray-600 dark:text-gray-400 text-sm">ARS</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white border-b-2 border-gray-300 dark:border-gray-600 pb-2">
              📈 Ingresos del Día
            </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border-2 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:outline-none"
                  placeholder="0.00"
                />
              </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-600">
              ...
              <div className="space-y-2 mb-3">
                <input
                  ...
                  className="w-full p-2 border-2 rounded-lg bg-white dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500 focus:border-blue-500 focus:outline-none text-sm"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-2 border-2 rounded-lg bg-white dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500 focus:border-blue-500 focus:outline-none text-sm"
              ...
              {gastosPersonalizados.length > 0 && (
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {gastosPersonalizados.map((gasto) => (
                    <div
                      key={gasto.id}
                      className="bg-gray-100 dark:bg-gray-600/50 p-2 rounded-lg border-2 border-gray-200 dark:border-gray-500 flex items-center justify-between group hover:border-blue-500 dark:hover:border-blue-500/50 transition-colors"
                    >
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{gasto.nombre}</p>
                      ...
                      <button
                        ...
                        className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors p-1 opacity-0 group-hover:opacity-100"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-600">
              <h4 className="text-sm font-bold text-blue-700 dark:text-blue-400 mb-3">💰 Gastos en Publicidad (mínimo uno requerido)</h4>
              ...
              <div className="mb-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-2 border-2 rounded-lg bg-white dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500 focus:border-blue-500 focus:outline-none"
                    placeholder="0.00"
                  />
                  <select
                    value={monedaMeta}
                    onChange={(e) => setMonedaMeta(e.target.value as MonedaAds)}
                    className="p-2 border-2 rounded-lg bg-white dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500 focus:border-blue-500 focus:outline-none"
                  >
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          ...
          <button
            ...
            className="flex-1 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-bold py-3 px-6 rounded-lg transition-colors duration-150 flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showResults && resultados && (
          <div className="bg-gradient-to-br from-blue-50 to-gray-100 dark:from-blue-900/50 dark:to-gray-700 p-6 rounded-2xl border-2 border-blue-300 dark:border-blue-500 space-y-4 animate-fadeIn">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-4 flex items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Total Gastos */}
              <div className="bg-white/80 dark:bg-gray-800/80 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-600">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Gastos</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatCurrency(resultados.totalGastos)}</p>
              ...
              <div className="bg-gray-800/80 p-4 rounded-lg border border-gray-600">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total al Bolsillo</p>
                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{formatCurrency(resultados.totalAlBolsillo)}</p>
              </div>

              {/* Rentabilidad % */}
              <div className="bg-gray-800/80 p-4 rounded-lg border border-gray-600">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Rentabilidad (%)</p>
                <p className={`text-3xl font-bold ${resultados.rentabilidadPorcentaje >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'}`}>
              ...
              {/* Margen Neto */}
              <div className="bg-gray-800/80 p-4 rounded-lg border border-gray-600">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Margen Neto</p>
                <p className={`text-2xl font-bold ${resultados.margenNeto >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'}`}>
            ...
            {/* Análisis adicional */}
            <div className="bg-white/80 dark:bg-gray-800/80 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-600">
              <p className="text-sm font-medium text-blue-600 dark:text-blue-400 mb-2">📊 Análisis:</p>
